...
`url_matrix`,`amigable_matrix`, `abre_matrix`,
...
<p>
  ...
  <label><?php if ($idr==7) {?> Vinculo Mapa<?php } else {?> <?php $valor = variable(65, 2);
...
?>
        ...
        <p><label><?php if ($idr==7) {?> Lugar<?php } else {?> Referencia<?php }?> <?php echo $nombre_modulo; ?> 
