$(document).ready(function(){
    ...
    $("#fecha_nacimiento").mask("99-99-9999", {placeholder: 'dd-mm-yyyy'});
    $("#ingreso_laboral").mask("99-99-9999", {placeholder: 'dd-mm-yyyy'});
    $("#retiro_laboral").mask("99-99-9999", {placeholder: 'dd-mm-yyyy'});
                ...
                if(res.data){
                    ...
                    $.each(res.data,function(name,value){
                       ...
                       if (name=='tipo_documento'){
                        $("#tipo_documento option[value='" + value + "']").prop('selected',true);
                       };
                       if(name=='nombre'){
                           $("#nombre").val(value);
                       } 
                       ...
                       if(name=='fecha_nacimiento'){
                            var fechan = value;
                            fechan = fechan.split("-");
                           $("#fecha_nacimiento").val(fechan[2]+"-"+fechan[1]+"-"+fechan[0]);
                       } 
                      ...
                      if(name=='independiente'){
                           if(value>0){
                               $("input[name=independiente]").prop("checked",true);                               
                           }
                       }
                       /*if(name=='contrasena'){
                    ...
                    var innerHtml='';
                        $.each(res.work,function(i,v){
                            ...
                            $.each(v,function(i,v){
                                    if(v!=""&&v!='0000-00-00'&&i!='id_laboral'&&v!=0){
                                        if (i=='motivo_laboral') {
                                          i="Fecha retiro";
                                          return false;
                                        }
                                        else if (i=='ingreso_laboral') {
                                          i="Fecha ingreso";
                                         var dato = v.split("-");
                                          if(dato[0].length==4)
                                          {
                                            v = dato[2]+"-"+dato[1]+"-"+dato[0];
                                          }
                                        }
                                        else if (i=='retiro_laboral') {                                         
                                          var dato = v.split("-");
                                          if(dato[0].length==4)
                                          {
                                            v = dato[2]+"-"+dato[1]+"-"+dato[0];
...
var saveCandidato =function(){
    ...
    var response=false;
        ...
        var fechana = $("#fecha_nacimiento").val();
        fechana = fechana.split("-");
        fechana = fechana[2]+"-"+fechana[1]+"-"+fechana[0];
        var clearData ={
             ...
             'independiente' :($("#independiente").is(':checked'))?1:0, 
        };
        /*cursos*/
