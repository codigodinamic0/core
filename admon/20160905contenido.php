...
$abre_matrix = $_POST['abre_matrix'] != "" ? $_POST['abre_matrix'] : "0";
$precio_matrix = $_POST['precio_matrix'] != "" ? $_POST['precio_matrix'] : "0.0";
$precio1_matrix = $_POST['precio1_matrix'] != "" ? $_POST['precio1_matrix'] : "0.0";
$inventario_matrix = $_POST['inventario_matrix'] != "" ? $_POST['inventario_matrix'] : "0";
$evento_matrix = $_POST['evento_matrix'] != "" ? $_POST['evento_matrix'] : $_POST['fecha_matrix'];
$ubica_matrix = $_POST['ubica_matrix'] != "" ? $_POST['ubica_matrix'] : "0";
/*fin validaciones*/
...
`id_tipo`) VALUES";
	...
	$sql = $sql . " , ".sql_seguro($abre_matrix); 
...
?>
                       ...
                       <tr>
                         ...
                         <td valign="top"><a href="#" title="<?= $row['nombre_categoria']?>" class="destacado_verde">

                           <?= $row['nombre_categoria']?>
                           <?php

 $db->select("v$carpeta","count(id_matrix) as total"," where id_categoria='".$row['id_categoria']."'");
$row_detalle = $db->fetch_assoc();
   ?>
                           <?php echo $row_detalle['total']; ?></a></td>

                         <td><?php  

$db->select("categoria","*"," where  de='" . $row['id_categoria'] . "'");
$row22 = $db->fetch_assoc();
?> 

<?php if ($row22['id_categoria']=='') {?><span style="padding:3px;"><a class="Ntooltip" href="contenido.php?idr=<?= $idr ?>&amp;nivel=<?php echo $nivel ?>&amp;id_categoria=<?php echo $row['id_categoria'] ?>" title="<?php $valor = variable(139, 2);  echo $valor[0]; ?> <?= $modulo; ?>">
