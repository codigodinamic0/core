...
if ($op=="1" ) { 
    ...
    $sql = "UPDATE $t1 SET ";
    $sql = $sql . "`nombre`='" . sql_seguro($_POST['nombre']) . "',"; 
	$sql = $sql . "`fecha`='" . sql_seguro($fecha2) . "'";
    $sql = $sql . " WHERE (`id`='" . sql_seguro($_POST['id']) . "')";
...
<? if ($op=="2") { 
	$sql = "INSERT INTO $t1(nombre) values " . 
...
$db->delete("encuesta_opcion","where id_sub='" . $_GET['idb'] . "'");
		  ...
		  <div class="clear"></div> <!-- End .clear -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<h3 class="img_menuiz"><?php echo $modulo ?> mysqli</h3>
...
?>
								...
								<tr>
								    ...
								    (<?php echo $row['id']?>)<?php echo $row['nombre']?> con<span class="destacado_verde"> <?php echo $row['votos']?></span> votos</a><a href="#" title="<?php echo $row['nombre']?>" class="txt_ingresar"> </span></a></td>
							  <td>
										<!-- Icons -->
...
<?php $valor=variable(1,2); echo $valor[0]; ?>  <?= $modulo; ?>
 ...
 <a class=Ntooltip href="encuesta_detalle.php?idr=<?= $row['id']?>&amp;op=4" title="Edit"><img src="imgs/information.png" alt="Edit" />
<span>
<?php $valor=variable(174,2); echo $valor[0]; ?> <?php echo $row['nombre']?>
</span>                                         </a>																	</td>
							  </tr>
                               <?php  }?>
							</tbody>
