 ...
 */
 class Crud{
    ...
    public function consulta_s($dato)
      {
        $this->cons = $this->mysqli->query($dato);
      }
    ...
    $str = function_exists("mysql_real_escape_string") ? strip_tags(mysql_real_escape_string(trim($str))):strip_tags(mysql_escape_string(trim($str)));
